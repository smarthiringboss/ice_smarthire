...
const TestTask = React.lazy(() => import('@/pages/TestTask'));
const CodeE = React.lazy(() => import('@/pages/CodeE'));
const Datatask = React.lazy(() => import('@/pages/Datatask'));
const Datacomp = React.lazy(() => import('@/pages/Datacomp'));
const Goto = React.lazy(() => import('@/pages/Goto'));
...
const routerConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: '/reports', redirect: '/reports/1576552862.html' },
      { path: '/datacomp', component: Datacomp },
      { path: '/datatask', component: Datatask },
      { path: '/code', component: CodeE },
      { path: '/TestTask', component: TestTask },
